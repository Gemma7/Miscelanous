...
namespace ProjectionOperators.Classes
{
    public class TestHelper
    {
        public static DataSet CreateTestDataset()
        {
            ...
            CreateCustomersAndOrdersTable(ds);
            ds.AcceptChanges();
        ...
        {
            DataTable table = new DataTable("Empty numbers");
            table.Columns.Add("number", typeof(int));
        ...
        {
            DataTable table = CreateProductTablet();
            ...
            {
                table.Rows.Add(new object[] { x.ProductId, x.ProductName, x.Category, 
        ...
        private static DataTable CreateProductTablet()
        {
        ...
        private static void CreateCustomersAndOrdersTable(DataSet ds)
        {
            ...
            {
                customers.Rows.Add(new object[] {cust.CustomerId, cust.CompanyName, cust.Address, 
                                                 cust.City, cust.Region, cust.PostalCode, 
                                                 cust.Country, cust.Phone, cust.Fax});
                foreach (Order order in cust.Orders)
                {
                    orders.Rows.Add(new object[] { order.OrderId, cust.CustomerId, 
